...
{
	if (m_keyboardState[DIK_UPARROW])
	{
		return true;
	}
	return false;
...
{
	if (m_keyboardState[DIK_DOWNARROW])
	{
		return true;
	}
	return false;
...
{
	if (m_keyboardState[DIK_LEFTARROW])
	{
		return true;
	}
	return false;
...
{
	if (m_keyboardState[DIK_RIGHTARROW])
	{
		return true;
	}
	return false;
